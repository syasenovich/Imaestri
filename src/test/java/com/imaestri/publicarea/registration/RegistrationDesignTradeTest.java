...
public class RegistrationDesignTradeTest  {
    ...
    public void testBusinessRegistration() {
        ...
        emailInput.sendKeys("svetlana.yasenovich+31@gmail.com");
        accountType.click();
...
////-----
        ...
        try {
            ...
            if (!step2Success.getText().equalsIgnoreCase("COMPLETE YOUR DESIGN TRADE ACCOUNT REGISTRATION"))
                Assert.fail("Step2 Design Trade account registration page was not opened.");
                ...
                try {
                    ...
                    Select dropCompanyTypeList = new Select(driver.findElement(By.id("company_type")));
                    dropCompanyTypeList.selectByVisibleText("Other");
